...
BEGIN
    ...
    IF p_idtypevehicle = 1 THEN
        ...
        VALUES(seq_vehicle.nextval, p_licensePlate, p_maxbattery, 100, p_ahBattery, p_vBattery, p_enginePower, 206,0.65, p_idPharmacy, p_idTypeVehicle); 
    ...
    ELSE
        ...
        VALUES(seq_vehicle.nextval, p_licensePlate, p_maxbattery, 100, p_ahBattery, p_vBattery, p_enginePower, 1.5,10,0.005, p_idPharmacy, p_idTypeVehicle); 
