...
BEGIN
    ...
    INSERT INTO Client(id, email, name, NIF, Addresslatitude, Addresslongitude,numberCreditCard) 
    VALUES (seq_client.nextval,p_email, p_name, p_NIF,  p_latitude, p_longitude, p_numberCreditCard);
