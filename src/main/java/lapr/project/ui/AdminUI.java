...
public class AdminUI {
    ...
    private void addPharmacy() {
        ...
        if (confirmation.equalsIgnoreCase("YES")) {
            ...
            if (added)
                Logger.getLogger(AdminUI.class.toString()).log(Level.INFO, "The pharmacy with the name {0}" + name + " was added!");
            else
    ...
    private void removeVehicle() {
        ...
        if (vc.removeVehicle(licencePlate)) {
            Logger.getLogger(AdminUI.class.toString()).log(Level.INFO, "The vehicle with the license plate {0} " + licencePlate + " was removed!");
        } else {
