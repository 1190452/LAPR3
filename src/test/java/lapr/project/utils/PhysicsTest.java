...
class PhysicsTest {
    ...
    void getNecessaryEnergy1() {
      ...
      double result = ph.getNecessaryEnergy(20000, 4, 1, 5, 10, 1, 90, 0.0020, 19999);
    ...
    void getNecessaryEnergy3() {
        ...
        double result = ph.getNecessaryEnergy(20000, 4, 1, 5, 10, 1, 0, 0.0020, 19999);
        assertEquals(expectedResult, result, 0.05);
    }
    ...
    void getNecessaryEnergy2() {
        ...
        double result = ph.getNecessaryEnergy(20000, 4, 2, 1, 10, 1, 180, 0.002 ,19999);
    ...
    void getNecessaryEnergy4() {
        ...
        double result = ph.getNecessaryEnergy(20000, 4, 2, 1, 10, 1, 0, 0.002, 19999);
        assertEquals(expectedResult, result, 0.001);
    }
    ...
    void getAerodynamicDragForce1() {
        ...
        double result = ph.getAerodynamicDragForce(1,5,4.50, 0, 0, 2);
    ...
    void getAerodynamicDragForce2() {
        ...
        double result = ph.getAerodynamicDragForce(2,1,  4.50, 0, 0, 3);
        assertEquals(expectedResult, result, 0.5);
    }
    ...
    void getAerodynamicDragForce3() {
        ...
        double result = ph.getAerodynamicDragForce(2,2, 4.50, 0, 0, 3);
        assertEquals(expectedResult, result, 0.5);
    }
    ...
    void getAerodynamicDragForce4() {
        double expectedResult = 4.388;
        double result = ph.getAerodynamicDragForce(3,2, 4.50, 0, 0, 3);
        assertEquals(expectedResult, result, 0.5);
    }
